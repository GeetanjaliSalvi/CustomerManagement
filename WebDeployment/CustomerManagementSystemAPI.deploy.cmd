...
set _DeploySetParametersFile=%RootPath%CustomerManagementSystemAPI.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%CustomerManagementSystemAPI.zip" (
echo "%RootPath%CustomerManagementSystemAPI.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%CustomerManagementSystemAPI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Release\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/CustomerManagementSystemAPI\\App_Data$'
) else (
...
:usage
echo =========================================================
if not exist "%RootPath%CustomerManagementSystemAPI.deploy-readme.txt" (
...
start notepad "%RootPath%CustomerManagementSystemAPI.deploy-readme.txt"
)
echo =========================================================
goto :eof
